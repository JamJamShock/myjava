...
public class Main {
    public static void main(String[] args) {
        ...
        products[0]=new TV("SamsungTV",2500,"Samsung",55);
        ...
        for(int i=0;i<products.length;i++){
            ...
            totalSalesPrice+=products[i].computeSalesPrice();
            System.out.println("Item : " + products[i].getClass().getSimpleName()
            +"RegularPrice : "+products[i].getPrice()+":"+
                    "SalesPrice : " + products[i].computeSalesPrice());
        }
